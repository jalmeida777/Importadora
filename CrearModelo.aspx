<%@ Page Title="Modelo" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="CrearModelo.aspx.cs" Inherits="CrearModelo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 ...
 <div class="toolbar">
        ...
        <tr>
            ...
            <td class="style1">
                <asp:TextBox ID="txtCodigoInterno" runat="server" CssClass="inputNormal" 
                    Width="20px" MaxLength="2" style="text-transform:uppercase"></asp:TextBox>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlMarca" runat="server" CssClass="combo" 
                    Width="200px">
                </asp:DropDownList>
