<%@ Page Title="Administración de Marcas" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ListarMarca.aspx.cs" Inherits="ListarMarca" %>
        ...
        AssociatedUpdatePanelID="UpdatePanel1">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="600px" ScrollBars="Vertical" 
                ...
                <asp:GridView ID="gvMarca" runat="server" AutoGenerateColumns="False" 
                    CssClass="grid" DataKeyNames="n_IdMarca" onrowdatabound="gvMarca_RowDataBound" 
                    Width="100%">
                    <Columns>
                        <asp:BoundField DataField="n_IdMarca" HeaderText="Id" Visible="False">
                        ...
                        <asp:BoundField DataField="v_DescripcionMarca" HeaderText="Marca" />
