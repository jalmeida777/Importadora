<%@ Page Title="" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="AperturaCaja.aspx.cs" Inherits="AperturaCaja" %>
        ...
        <tr>
            ...
            <td>
                ...
                &nbsp;</td>
                    ...
                    Text="Apertura de Caja" ForeColor="#4C4C4C"></asp:Label>
                            </td>
                            <td>
                                &nbsp;</td>
                        </tr>
                                ...
                                <table width="100%">
                                    <tr>
                                        <td style="border-right-style: solid; border-right-width: 1px; border-right-color: #339933" 
                                            width="100">
                                <asp:Label ID="Label29" runat="server" Text="Sucursal:" ForeColor="#4C4C4C"></asp:Label>
                                        </td>
                        ...
                        <td>
                            <asp:ImageButton ID="ibEstablecerSucursal" runat="server" 
                                ...
                                <asp:TextBox ID="txtmonto" runat="server" CssClass="inputNormalMoneda" 
                                                onkeypress="return ValidaNumeros(event);" Width="70px" Enabled="False">0.00</asp:TextBox>
                                        </td>
                                    </tr>
                                    </table>
                            </td>
