<%@ Page Title="Administración de Categorías" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="ListarCategoria.aspx.cs" Inherits="ListarCategoria" %>
        ...
        AssociatedUpdatePanelID="UpdatePanel1">
            ...
            <asp:Panel ID="Panel1" runat="server" Height="600px" ScrollBars="Vertical" 
                ...
                <asp:GridView ID="gvCategoria" runat="server" AutoGenerateColumns="False" 
                    CssClass="grid" DataKeyNames="n_IdCategoria" 
                    onrowdatabound="gvCategoria_RowDataBound" Width="100%">
                    <Columns>
                        <asp:BoundField DataField="n_IdCategoria" HeaderText="Id" Visible="False">
                        ...
                        <asp:BoundField DataField="v_Descripcion" HeaderText="Familia" />
