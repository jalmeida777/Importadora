<%@ Page Title="Categoría" Language="C#" MasterPageFile="~/Plantilla.master" AutoEventWireup="true" CodeFile="CrearCategoria.aspx.cs" Inherits="CrearCategoria" %>
 ...
 <div class="toolbar">
        ...
        <tr>
            <td height="10" width="20">
                &nbsp;</td>
            <td width="120">
                <asp:Label ID="Label4" runat="server" Text="Código Interno:"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtCodigoInterno" runat="server" CssClass="inputNormal" 
                    Width="30px" MaxLength="3" style="text-transform:uppercase"></asp:TextBox>
